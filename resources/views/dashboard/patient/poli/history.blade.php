                ...
                <div class="row mb-2">
                    <div class="col">
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.patient.poli.index') }}">Daftar Poli</a></li>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            Jam : {{ date('H:i', strtotime($checkup->schedule->start_time)) }} s/d
                                            {{ date('H:i', strtotime($checkup->schedule->end_time)) }}
                                            <br>
