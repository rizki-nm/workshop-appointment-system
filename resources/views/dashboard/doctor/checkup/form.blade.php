...
@section('title', 'Dokter | CheckUp Pasien')
@section('content')
                ...
                <div class="row mb-2">
                    <div class="col">
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.doctor.checkup.index') }}">Daftar Pasien</a></li>
                            <li class="breadcrumb-item active">CheckUp Pasien</li>
                        </ol>
                    </div>
                </div>
            </div>
